...
@app.route('/AssemAI.html')
def NS_HyMAP():
    return render_template('AssemAI.html')
...
def get_latest_data():
    global r02, r03, Predicted_R03, Predicted_R02, ImageAnomalyLabel
    ...
    if response.status_code == 200:
        ...
        ImageAnomalyLabel = response.json()['ImageAnomalyLabel']

        return latest_R02, latest_R03, CycleState, AnomalyLabel, Predicted_R02, Predicted_R03,ImageAnomalyLabel
    else:
        # Print an error message if the request was unsuccessful
        print("Error:", response.status_code)
        return [0, 0, "N/A", "N/A", "N/A", "N/A", "N/A"]  # Placeholder for demonstration purposes


@app.route('/api/data')
def api_data():
    global r02, r03, CycleState, AnomalyLabel, Predicted_R02, Predicted_R03, ImageAnomalyLabel
    r02, r03, CycleState, AnomalyLabel, Predicted_R02, Predicted_R03, ImageAnomalyLabel = get_latest_data()
    return jsonify({'r02': r02, 'r03': r03, 'CycleState': CycleState, 'AnomalyLabel': AnomalyLabel,
                    'Predicted_R02': Predicted_R02, 'Predicted_R03': Predicted_R03, 'ImageAnomalyLabel': ImageAnomalyLabel})
